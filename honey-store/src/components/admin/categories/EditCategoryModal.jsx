...
export default function EditCategoryModal({ category, onClose, onSave }) {
  ...
  /* sync fields if category prop changes */
  useEffect(() => {
  ...
  function handleSave() {
    ...
    onSave({ id: category.id, name: title.trim(), description: description.trim() });
    closeWithAnimation();
  }
    ...
    <div className="fixed inset-0 z-50 flex">
      ...
      >
        ...
        <div className="flex items-center justify-between px-7 pt-7 pb-5 border-b border-gray-100">
          <h2 className="text-[18px] font-semibold text-gray-900">Edit Category</h2>
          <button
            onClick={() => closeWithAnimation()}
        ...
        <div className="flex-1 overflow-y-auto px-7 py-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              autoFocus
              className="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-[13.5px] text-gray-800 focus:outline-none focus:ring-2 focus:ring-amber-400/40 focus:border-amber-400 transition-all bg-gray-50 focus:bg-white"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-[13.5px] text-gray-800 focus:outline-none focus:ring-2 focus:ring-amber-400/40 focus:border-amber-400 transition-all resize-none bg-gray-50 focus:bg-white"
            />
          </div>
        </div>
