...
export default function EditCategoryModal({ category, onClose, onSave }) {
  ...
  /* keep fields in sync if the modal is reused for different categories */
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* Modal card */}
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-7 animate-in fade-in zoom-in-95 duration-150">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-[17px] font-semibold text-gray-900">Edit Category</h2>
          <button
            onClick={onClose}
