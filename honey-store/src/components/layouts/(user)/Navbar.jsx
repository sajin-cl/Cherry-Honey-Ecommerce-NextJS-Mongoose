        ...
        {menuOpen && (
          <div className="md:hidden bg-black/95 border-t border-gray-800 px-6 py-4 space-y-4">
            <Link 
              ...
              className={`flex items-center gap-3 text-sm transition-colors duration-200 ${isActive('/') ? 'text-[#C8A84B] font-medium' : 'text-gray-300 hover:text-[#C8A84B]'}`}
            >
              <svg className={`w-4 h-4 transition-colors duration-200 ${isActive('/') ? 'text-[#C8A84B]' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <Link 
              href="/products" 
              onClick={() => setMenuOpen(false)}
              className={`flex items-center gap-3 text-sm transition-colors duration-200 ${isActive('/products') ? 'text-[#C8A84B] font-medium' : 'text-gray-300 hover:text-[#C8A84B]'}`}
            >
              <svg className={`w-4 h-4 transition-colors duration-200 ${isActive('/products') ? 'text-[#C8A84B]' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <Link 
              href="/orders" 
              onClick={() => setMenuOpen(false)}
              className={`flex items-center gap-3 text-sm transition-colors duration-200 ${isActive('/orders') ? 'text-[#C8A84B] font-medium' : 'text-gray-300 hover:text-[#C8A84B]'}`}
            >
              <svg className={`w-4 h-4 transition-colors duration-200 ${isActive('/orders') ? 'text-[#C8A84B]' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <Link 
              href="/about" 
              onClick={() => setMenuOpen(false)}
              className={`flex items-center gap-3 text-sm transition-colors duration-200 ${isActive('/about') ? 'text-[#C8A84B] font-medium' : 'text-gray-300 hover:text-[#C8A84B]'}`}
            >
              <svg className={`w-4 h-4 transition-colors duration-200 ${isActive('/about') ? 'text-[#C8A84B]' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <Link 
              href="/contact" 
              onClick={() => setMenuOpen(false)}
              className={`flex items-center gap-3 text-sm transition-colors duration-200 ${isActive('/contact') ? 'text-[#C8A84B] font-medium' : 'text-gray-300 hover:text-[#C8A84B]'}`}
            >
              <svg className={`w-4 h-4 transition-colors duration-200 ${isActive('/contact') ? 'text-[#C8A84B]' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
