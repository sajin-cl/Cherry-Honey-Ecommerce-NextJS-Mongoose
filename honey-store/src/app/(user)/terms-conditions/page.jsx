import { ADMIN_PHONE, CUSTOMER_CARE_EMAIL, serif, TERMS_AND_CONDITIONS_SECTIONS } from "@/config/staticData";
import Link from "next/link";

export const metadata = {
    title: "Terms & Conditions | Cherrys Honey",
    description: "Read the Terms & Conditions governing your use of the Cherrys Honey website and services.",
    alternates: {
                ...
                <div className="space-y-12">
                    {TERMS_AND_CONDITIONS_SECTIONS.map((section, idx) => (
                        <div key={idx}>
                            ...
                            {/* Divider */}
                            {idx < TERMS_AND_CONDITIONS_SECTIONS.length - 1 && (
