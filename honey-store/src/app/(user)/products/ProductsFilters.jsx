      ...
      <div className="flex items-center gap-3">
        ...
        <form onSubmit={handleSearchSubmit} className="flex items-center">
          <input
            ...
            className="bg-[#111] border border-gray-800 hover:border-gray-700 text-white text-xs px-4 py-2.5 placeholder-gray-500 focus:outline-none focus:border-[#C8A84B] transition-all w-48 sm:w-64"
          />
          <button
            type="submit"
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#C8A84B] hover:bg-[#b8973e] text-black text-xs font-bold px-5 py-2.5 transition-all uppercase tracking-wider"
        >
