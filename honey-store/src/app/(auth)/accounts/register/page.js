...
export default function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log({ fullName, mobile, email, password, confirmPassword, agreeTerms });
  };
      ...
      <div className="flex w-full md:w-1/2 h-full items-center justify-center bg-[#111111]">
        <div className="w-full max-w-md px-10">
          ...
          <p className="text-sm text-gray-400 mb-10">
            ...
            <Link href="/accounts/login" className="font-bold text-gray-200 hover:text-white transition-colors">
              Sign in
            </Link>
          </p>
            ...
            <div className="flex items-center pt-1">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div className="relative">
                  ...
                  <div
                    className={`w-4 h-4 border transition-colors ${
                      agreeTerms ? "bg-[#C8A84B] border-[#C8A84B]" : "bg-transparent border-gray-500"
                ...
                <span className="text-sm text-gray-400 group-hover:text-gray-200 transition-colors select-none">
                  I agree with{" "}
                  <Link href="/privacy-policy" className="font-bold text-gray-200 hover:text-[#C8A84B] underline transition-colors">
                    Privacy Policy
                  </Link>{" "}
                  and{" "}
                  <Link href="/terms" className="font-bold text-gray-200 hover:text-[#C8A84B] underline transition-colors">
                    Terms of Use
                  </Link>
                </span>
              </label>
